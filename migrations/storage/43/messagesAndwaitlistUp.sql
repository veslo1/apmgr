...
--
-- Host: localhost
-- Generation Time: May 30, 2010 at 07:50 PM
...
--
-- Table structure for table `userWaitlist`
--

DROP TABLE IF EXISTS `userWaitlist`;
CREATE TABLE IF NOT EXISTS `userWaitlist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `modelId` int(11) unsigned NOT NULL COMMENT 'The model id the user was applying to',
  `comments` text,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `modelId` (`modelId`),
  KEY `userId` (`userId`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='User waitlist table' AUTO_INCREMENT=3 ;

--
-- Dumping data for table `userWaitlist`
--

REPLACE INTO `userWaitlist` (`id`, `userId`, `modelId`, `comments`, `dateCreated`, `dateUpdated`) VALUES
(1, 18, 1, NULL, '2010-05-30 19:48:13', '2010-05-30 19:48:13'),
(2, 18, 1, NULL, '2010-05-30 19:48:33', '2010-05-30 19:48:33');
...
--
-- Constraints for table `userWaitlist`
--
ALTER TABLE `userWaitlist`
  ADD CONSTRAINT `userWaitlist_ibfk_1` FOREIGN KEY (`modelId`) REFERENCES `unitModel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
