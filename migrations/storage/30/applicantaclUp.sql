...
--
-- Host: localhost
-- Generation Time: May 21, 2010 at 09:39 PM
...
CREATE TABLE IF NOT EXISTS `controllers` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`(5))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='All the controllers that we have' AUTO_INCREMENT=13 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Relation between roles and permissions' AUTO_INCREMENT=71 ;
