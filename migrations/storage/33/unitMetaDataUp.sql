...
--
-- Host: localhost
-- Generation Time: May 23, 2010 at 12:04 PM
...
(53, 'The operation couldn''t continue', 'metadataDfail', 'error', 'en_US', 1, '2010-05-23 11:47:13', NULL),
(54, 'Picture deleted', 'unitmetadatadeleted', 'success', 'en_US', 1, '2010-05-23 11:51:13', NULL);

ALTER TABLE `unitMetaData` ADD `deleted` BOOLEAN NOT NULL DEFAULT '0' COMMENT 'Logical field' AFTER `description` 
