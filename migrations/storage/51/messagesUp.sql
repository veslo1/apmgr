...
CREATE DATABASE IF NOT EXISTS apmgr;
USE apmgr;

--
-- Definition of table `apmgr`.`messages`
--

DROP TABLE IF EXISTS `apmgr`.`messages`;
CREATE TABLE  `apmgr`.`messages` (
...
--
-- Dumping data for table `apmgr`.`messages`
--

/*!40000 ALTER TABLE `messages` DISABLE KEYS */;
INSERT INTO `apmgr`.`messages` (`id`,`message`,`identifier`,`category`,`language`,`locked`,`dateCreated`,`dateUpdated`) VALUES 
