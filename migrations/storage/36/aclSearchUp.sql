...
CREATE TABLE `modules` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`(5))
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='The content of the modules folder, ie all the modules';
...
INSERT INTO `modules` (`id`, `name`, `icon`, `display`, `dateCreated`, `dateUpdated`) VALUES (1,'calendar','/images/dashboard/calendar.png',1,'2010-04-20 15:03:36',NULL),(2,'default','/images/dashboard/ok.gif',1,'2010-04-20 15:03:36',NULL),(3,'financial','/images/dashboard/dollar.gif',1,'2010-04-20 15:03:36',NULL),(4,'logs',NULL,0,'2010-04-20 15:03:36',NULL),(5,'maintenance','/images/dashboard/spanner_48.gif',1,'2010-04-20 15:03:36',NULL),(6,'messages','/images/dashboard/messages.gif',1,'2010-04-20 15:03:36',NULL),(7,'modules',NULL,0,'2010-04-20 15:03:36',NULL),(8,'permission','/images/dashboard/onebit_04.gif',1,'2010-04-20 15:03:36',NULL),(9,'role','/images/dashboard/role.gif',1,'2010-04-20 15:03:36',NULL),(10,'unit','/images/dashboard/apartment.gif',1,'2010-04-20 15:03:36',NULL),(11,'user','/images/dashboard/user_48.gif',1,'2010-04-20 15:03:36',NULL),(12,'applicant',NULL,0,'2010-05-20 22:10:40',NULL);
...
CREATE TABLE `controllers` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`(5))
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='All the controllers that we have';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `controllers` (`id`, `name`, `icon`, `display`, `dateCreated`, `dateUpdated`) VALUES (1,'Create','/images/dashboard/onebit_48.gif',1,'2010-04-20 15:03:36',NULL),(2,'Index','/images/dashboard/onebit_01.gif',1,'2010-04-20 15:03:36',NULL),(3,'Delete','/images/dashboard/onebit_32.gif',0,'2010-04-20 15:03:36','2010-05-01 13:45:06'),(4,'Update','/images/dashboard/onebit_20.gif',0,'2010-04-20 15:03:36','2010-05-01 13:45:31'),(5,'View','/images/dashboard/onebit_02.gif',1,'2010-04-20 15:03:36',NULL),(6,'Error',NULL,0,'2010-04-20 15:03:36',NULL),(7,'Search',NULL,0,'2010-04-20 15:03:36',NULL),(8,'Leasewizard',NULL,0,'2010-04-20 15:03:37',NULL),(9,'Tenet',NULL,0,'2010-04-20 15:03:37',NULL),(10,'Join',NULL,0,'2010-04-20 15:03:37',NULL),(11,'Login',NULL,0,'2010-04-20 15:03:37',NULL),(12,'Add',NULL,0,'2010-05-14 21:09:47',NULL),(13,'Backend',NULL,0,'2010-05-22 12:12:17',NULL),(14,'Apply',NULL,0,'2010-05-22 12:12:17',NULL);
...
CREATE TABLE `permission` (
  ...
  CONSTRAINT `permission_ibfk_1` FOREIGN KEY (`moduleId`) REFERENCES `modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COMMENT='Relation between roles and permissions';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rolePermission` (`id`, `roleId`, `permissionId`, `dateCreated`, `dateUpdated`) VALUES (1,2,1,'2010-04-20 16:07:44',NULL),(2,3,1,'2010-04-20 16:07:47',NULL),(3,2,2,'2010-04-20 16:07:49',NULL),(4,3,2,'2010-04-20 16:07:52',NULL),(5,3,4,'2010-04-20 16:07:56',NULL),(6,2,4,'2010-04-20 16:07:58',NULL),(7,2,3,'2010-04-20 16:07:59',NULL),(8,2,6,'2010-04-20 16:08:06',NULL),(9,2,5,'2010-04-20 16:08:09',NULL),(10,3,5,'2010-04-20 16:08:11',NULL),(11,3,6,'2010-04-20 16:08:13',NULL),(12,3,3,'2010-04-20 16:08:16',NULL),(13,2,110,'2010-04-20 16:08:35',NULL),(14,2,119,'2010-04-20 16:08:37',NULL),(16,2,118,'2010-04-20 16:08:42',NULL),(17,