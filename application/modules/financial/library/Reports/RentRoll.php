<?php
/**
 * Rent roll report implementation
 * @author Jorge Omar Vazquez <jvazquez@debserverp4.com.ar>
 * @link http://gaymine.dyndns-free.com/projects/rnam/wiki/RentRoll_Report
 */

class Financial_Library_Reports_RentRoll extends ZFReport_Library_Base
{
	 ...
	 * @var const
	 */
	const CACHEIDENTIFIER='rentRoll';

	/**
	 * The default seed for cache
	 * @var const
	 */
	const DEFAULTSEED='rentRollReport';
	 ...
	 * @var array
	 */
	public static $columnMap=array('unitNumber','tenantName','rentAmount','leaseEffectiveDate','leaseEndDate');
	...
	private function query()
	{
		...
		$query->from(array('L'=>'lease'),array('leaseStartDate'=>"DATE_FORMAT(L.leaseStartDate,'%m/%d/%Y')",'leaseEndDate'=>"DATE_FORMAT(L.leaseEndDate,'%m/%d/%Y')",'lastDay'=>"DATE_FORMAT(L.lastDay,'%m/%d/%Y')"))
	...
	{
		$cache = $this->cache->getCache(Financial_Library_Reports_RentRoll::CACHEIDENTIFIER);
