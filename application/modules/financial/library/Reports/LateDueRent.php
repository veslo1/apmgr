...
/**
 * Late Due Rent 
 * @link http://gaymine.dyndns-free.com/projects/rnam/wiki/LateDueRent
 */

class Financial_Library_Reports_LateDueRent extends ZFReport_Library_Base
{
	 ...
	 * @var const
	 */
	const CACHEIDENTIFIER='lateDueRent';

	/**
	 * The default seed for cache
	 * @var const
	 */
	const DEFAULTSEED='lateDueRentReport';
	 ...
	 * @var array
	 */
	public static $columnMap=array('unitNumber','rentAmountDue','rentDueDate','numDaysLate','tenantName');
	...
	private function query()
	{
		...
		->join(array('B'=>'bill'),'LS.billId=B.id',array('rentAmountDue'=>'B.originalAmountDue','rentDueDate'=>"DATE_FORMAT(B.dueDate,'%m/%d/%Y')", 'numDaysLate'=>'DATEDIFF(NOW(),B.dueDate)'))		
	...
	{
		$cache = $this->cache->getCache(Financial_Library_Reports_LateDueRent::CACHEIDENTIFIER);
	...
	public function exportReport()
	{
		...
		$worksheet = &$workbook->addWorksheet('Late Due Rent');
