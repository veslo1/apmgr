...
/**
 * Late Due Fee
 * @link http://gaymine.dyndns-free.com/projects/rnam/wiki/DueFees
 */

class Financial_Library_Reports_DueFee extends ZFReport_Library_Base
{
	 ...
	 * @var const
	 */
	const CACHEIDENTIFIER='dueFee';

	/**
	 * The default seed for cache
	 * @var const
	 */
	const DEFAULTSEED='dueFeeReport';
	 ...
	 * @var array
	 */
	public static $columnMap=array('unitNumber','feeAmountDue','feeDueDate','numDaysUntilDue','tenantName','feeName');
	...
	private function query()
	{
		...
		->join(array('B'=>'bill'),'LF.billId=B.id',array('feeAmountDue'=>'B.originalAmountDue','feeDueDate'=>"DATE_FORMAT(B.dueDate,'%m/%d/%Y')", 'numDaysUntilDue'=>'DATEDIFF(B.dueDate,NOW())'))		
	...
	public function exportReport()
	{
		...
		$worksheet = &$workbook->addWorksheet('Due Fee');
