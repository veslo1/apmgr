...
class City_DeleteController extends Zend_Controller_Action {
	/**
	 * Fetch all the roles that you can delete.
	 */
	public function indexAction() {
		$city = new City_Model_City();
		$this->view->record =  $city->fetchAll();
	}
	...
	public function deleteAction() {
		...
		$this->_helper->redirector('index', 'view', 'city',array('msg'=> $msg) );
	}
}
?>
