<?php
/**
 * Outgoing Tenants Report
 * @link http://gaymine.dyndns-free.com/projects/rnam/wiki/OutgoingTenants
 */

class Unit_Library_Reports_OutgoingTenants extends ZFReport_Library_Base
{
	 ...
	 * @var const
	 */
	const CACHEIDENTIFIER='outgoingTenants';

	/**
	 * The default seed for cache
	 * @var const
	 */
	const DEFAULTSEED='outgoingTenantsReport';
	 ...
	 * @var array
	 */
	public static $columnMap=array('unitNumber','rentAmount','leaseEffectiveDate','leaseEndDate','tenantName');
	...
	public function exportReport()
	{
		...
		*/
		...
		$worksheet = &$workbook->addWorksheet('outgoing Tenants');
