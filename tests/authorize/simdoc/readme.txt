...
- PHP versions prior to 5.1.2 do not include native support for generating the
  necessary HMAC MD5 hash.  If you are using a PHP version prior to 5.1.2, it is
  required that you have the mhash module installed.  You can find this at: 
