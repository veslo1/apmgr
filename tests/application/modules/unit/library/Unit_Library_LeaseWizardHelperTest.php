<?php
/**
 *  Lease Wizard Helper tests
 *
 *  phpunit --no-configuration --bootstrap application/bootstrap.php application/modules/unit/library/Unit_Library_LeaseWizardHelperTest.php
 */
class Unit_Library_LeaseWizardHelperTest extends ControllerTestCase
{
	/**
	 * @var Unit_Library_LeaseWizardHelper
	 */
	protected $object;
