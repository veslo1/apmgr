<?php
/**
 * Test class for Unit_Library_Reports_OutgoingTenantsTest
 * Generated by PHPUnit on 2010-10-29 at 23:31:16.
 */
// phpunit --no-configuration --bootstrap application/bootstrap.php application/modules/unit/library/reports/Unit_Reports_OutgoingTenantsTest.php
class Unit_Library_Reports_OutgoingTenantsTest extends ControllerTestCase {
	...
	{
		parent::setUp();
		$this->dataSetStackBuffer = array('outgoingTenantsReport'=>1);
	...
	{
		$object = new Unit_Library_Reports_OutgoingTenants;
		$object->setGatewayLink(Unit_Library_Reports_OutgoingTenants::DB);
	...
	{
		$object = new Unit_Library_Reports_OutgoingTenants(array('cacheIdentifier'=>'outgoingTenants'));
	...
	public function testRunReportWithCache()
	{
		...
		$this->assertEquals(Unit_Library_Reports_OutgoingTenants::DEFAULTSEED,$object->getSeed());
	}

	public function testQueryWithSort()
	{
		$args = array(ZFInterfaces_Sortable::MODE=>ZFInterfaces_Sortable::ASCVIEW,
		ZFInterfaces_Sortable::COLUMN=>'leaseEndDate');
		$object = new Unit_Library_Reports_OutgoingTenants($args);
		$result = $object->runReport(false);
		//var_dump($object->getQuery()); die;
		$this->assertTrue(preg_match('/ORDER BY leaseEndDate ASC/',$object->getQuery())==1,$object->getQuery());
	}
	...
	public function testHandleQueryParamsMultiple()
	{
		...
		ZFInterfaces_Sortable::COLUMN=>'tenantName','page'=>2,
        			'cacheIdentifier'=>Unit_Library_Reports_OutgoingTenants::CACHEIDENTIFIER);
		$object = new Unit_Library_Reports_OutgoingTenants($args);
		$object->prepareCacheSeed();		
		$this->assertEquals('outgoingTenantsReportpage2tenantNameASC',$object->getSeed());
	}
	...
	public function testHandleQueryParamsPagination()
	{
		...
		$object = new Unit_Library_Reports_OutgoingTenants($args);
		$object->prepareCacheSeed();
		$this->assertEquals('outgoingTenantsReportpage2',$object->getSeed());
	}
	...
	public function testHandleQueryParamsBadPagination()
	{
		...
		$object = new Unit_Library_Reports_OutgoingTenants($args);
		$object->prepareCacheSeed();
		$this->assertEquals('outgoingTenantsReport',$object->getSeed());
		unset($object);
		$args = array('page'=>"x3");
		$object = new Unit_Library_Reports_OutgoingTenants($args);
		$object->prepareCacheSeed();
