...
class ZFDate_CalendarHtml {
	 ...
	 */
	protected $monthNames = array("January", "February", "March", "April",
	 ...
	 * contains twelve elements, one for each month of the year. The first entry
	 ...
	 * @param boolean $show
	 */
	public function setShowYear($show) {
		$this->showYear = $show;
	}
	 ...
	 * @return string
	 */
	protected function getMonthHTML($m, $y, $showYear = 1) {
		$s = "";
